...
//        Adds box2d.Filter to the Physic objects.
//        Is required for the ContactListenerSystem or scripts with collision detection.

//        Adds a floor sensor to the player, including a filter


@All(PhysicsBodyComponent.class)
public class SetFilterDataSystemNew extends IteratingSystem {
    ...
    public SetFilterDataSystemNew() {
        System.out.println("[SetFilterDataSystemNew] create SetFilterDataSystemNew");
    }
